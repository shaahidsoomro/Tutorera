...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // Market landing pages may exist for discovery, but only LIVE markets belong in the XML sitemap.
  ...
  // Generic directory hubs are useful crawl paths; granular programmatic pages below are inventory-gated.
  ...
  // This list mirrors the routes generated by /pk/tutors/city/[city]/[level]/[subject].
  // A URL is exposed to crawlers only when the exact Render-backed combination has supply.
  ...
  // Defensive de-duplication prevents overlapping directory generators from producing duplicate <url> entries.
